...
import main.ru.geekbrains.Lesson2.Server.annotations.AutoIncrement;
import main.ru.geekbrains.Lesson2.Server.annotations.PrimaryKey;
import main.ru.geekbrains.Lesson2.Server.annotations.Table;
import main.ru.geekbrains.Lesson2.Server.annotations.Unique;
...
public class UserRepository<T> {
    ...
    public static void insert(User user) throws SQLException {
        ...
        for (Field fld : clazz.getDeclaredFields()) {
            ...
            if (fld.isAnnotationPresent(main.ru.geekbrains.Lesson2.Server.annotations.Field.class)) {
                main.ru.geekbrains.Lesson2.Server.annotations.Field fldAnnotation = fld.getAnnotation(main.ru.geekbrains.Lesson2.Server.annotations.Field.class);
